...
class CompoundProduct(SchemaTableMixin, BaseModel):
    ...
    media_policy: Mapped[str] = mapped_column(String(32), nullable=False, default="prefer_manual")
    media_display_mode: Mapped[str] = mapped_column(String(32), nullable=False, default="on_demand")
    sync_images: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    sync_videos: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    sync_sources: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
